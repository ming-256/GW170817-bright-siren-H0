"""
Compare phase-marginalised IMRPhenomD vs TaylorF2 (local, GWTC PSD) + LVK.
Uses hist_1d on diagonal, kde_2d on lower triangle.
"""
...
# --------------------------------------------------------------------------- #
# Files to plot: phase-marginalised only
# --------------------------------------------------------------------------- #
RESULTS_DIR = 'Results'
RUNS = [
    (
...
LVK_samples.plot_2d(
    ...
    lower_kwargs=dict(levels=[0.99730, 0.95450, 0.68269], ncompress=5000),
...
fig.suptitle('Phase-Marginalised: IMRPhenomD vs TaylorF2 — GWTC PSD', fontsize=14, y=1.01)
fig.tight_layout()
axes.tick_params(grid_alpha=0)

corner_path = 'Plots/Results/corner_phasemarg_gwtc'
...
if not h0_runs:
    ...
    fig2.suptitle('Phase-Marginalised: IMRPhenomD vs TaylorF2 — GWTC PSD', fontsize=14)
    fig2.tight_layout()

    h0_path = 'Plots/Results/H0_phasemarg_gwtc'
