"""
Corner plot: GW170817 — baseline TaylorF2 (heterodyned) vs
unheterodyned TaylorF2 vs GWTC-1.
...
UNHETERO_CSV = os.path.join(RESULTS_DIR,
    'gwtc1_phasemarg/PhaseMarg_Unheterodyned_TaylorF2_local_psd-gwtc1.csv')
