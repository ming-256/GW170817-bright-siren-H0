"""
H_0 posterior: IMRPhenomD_NRTidalv2 — baseline / reweighted flat-in-z / vp250.
...
REWEIGHTED_CSV = os.path.join(RESULTS_DIR,
    'gwtc1_phasemarg/PhaseMarg_Heterodyned_IMRPhenomD_NRTidalv2_local_psd-gwtc1_ref-gwtc1_reweighted_flatZ.csv')
...
if runs:
    plot_h0(runs, 'H0_IMRPhenomD_reweighted')
else:
    print("  No data found.")
