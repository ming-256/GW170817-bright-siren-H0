...
# NOTE: the cross-waveform H0 table in the paper (tab:waveform-h0) is the
# volumetric d_L^2 baseline set (IMRX = s14 baseline, TF = the gwtc1_phasemarg
# TaylorF2 baseline) and is generated by scripts/build_waveform_table.py. The
# old s07 "LVK-bounds" cross-waveform set is superseded and no longer emitted.
...
# --------------------------------------------------------------------------- #
def main():
    # Table 4 (cross-waveform) is generated separately by build_waveform_table.py.
    print('=== Table 5: prior sensitivity (default-mass full-sky) ===')
    t5 = []
